package mvc.controller; // coloca la clase compilada en tpvlibre/conexiones
...
public class ManejadorBaseDatos {
    ...
    private String password = "Marto16"; // contrase�a del usuario que se puede conectar
    ...
    private String basedatos = "jdbc:mysql://localhost:3306/credinet";
